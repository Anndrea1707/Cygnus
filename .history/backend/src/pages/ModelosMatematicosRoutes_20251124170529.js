...
// En pages/ModelosMatematicosRoutes.js - MODIFICAR la ruta existente:
...
router.post('/seleccionar-preguntas', async (req, res) => {
  try {
    ...
    const preguntasSeleccionadas = require('../models/ModelosMatematicos').seleccionarPreguntasAdaptativas(
      preguntas,
      usuario,
      cantidad
    );
