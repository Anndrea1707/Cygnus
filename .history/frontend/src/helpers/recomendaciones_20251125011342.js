...
export function obtenerRecomendacionPorcentual(porcentaje) {
    if (porcentaje >= 0 && porcentaje <= 10) {
        ...
        return {
            tipo: "repaso_fuerte",
            mensaje: "Necesitas repasar los conceptos principales, asì mejoraras tus conocimientos",
            bloqueoMinutos: 45,
            puedeAvanzar: false
        };
        ...
        return {
            ...
            mensaje: "Un repaso te ayudará a mejorar tu puntaje, tu puedes!",
            bloqueoMinutos: 30,
            puedeAvanzar: false
        };
        ...
        return {
            tipo: "repaso_leve",
            mensaje: "Estás cerca, un breve repaso te llevará al éxito. Recuerda ",
            bloqueoMinutos: 15,
            puedeAvanzar: false
        };
