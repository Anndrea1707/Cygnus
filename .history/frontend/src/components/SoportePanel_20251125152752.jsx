...
export default function SoportePanel({ onClose, tipoVista, setTipoVista, usuario }) {
    ...
    const faqs = [
        ...
        },
        {
            ...
            respuesta: "La tabla de progreso semanal te muestra tu consistencia y evolución en el aprendizaje. Registra tus sesiones de estudio diarias, los temas revisados y tu rendimiento general. Las celdas coloayudándote a mantener una rutina de estudio constante."
        },
        {
