...
export default function EvaluacionFinal({ curso, evaluacion, onNavigate, onEvaluacionCompletada }) {
    ...
    const finalizarEvaluacion = async () => {
        ...
        const notaFinal = puntajeCalculado / 20;
        ...
        try {
            ...
            const response = await fetch("http://localhost:4000/api/progreso/evaluacion-final", {
                method: "POST",
            ...
            if (result.success) {
                console.log("✅ Evaluación final guardada:", result);
            }
