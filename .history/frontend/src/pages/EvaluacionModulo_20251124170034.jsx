...
const preguntas = preguntasAdaptativas.length > 0 ? preguntasAdaptativas : (modulo?.evaluacion?.preguntas || []);    const tiempoTotal = preguntas.length * 2 * 60; // 2 minutos por pregunta en segundos
