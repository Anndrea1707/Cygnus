...
export default function EvaluacionModulo({ curso, modulo, moduloIndex, onNavigate, onEvaluacionCompletada }) {
    ...
    const finalizarEvaluacion = async () => {
        ...
        const notaFinal = puntajeCalculado / 20; // Convierte 0–100 → 0–5
        ...
        try {
            ...
            await fetch("http://localhost:4000/api/progreso/evaluacion", {
                method: "POST",
                headers: { "Content-Type": "application/json" },
                body: JSON.stringify({
                    usuarioId: usuario._id,
                    cursoId: curso.id,
                    moduloIndex, // ← este viene por props
                    nota: notaFinal
                })
            });
  ...
  onEvaluacionCompletada(moduloIndex); // viene desde App.jsx
};
