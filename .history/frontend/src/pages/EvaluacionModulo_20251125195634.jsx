...
export default function EvaluacionModulo({ curso, modulo, moduloIndex, onNavigate, onEvaluacionCompletada }) {
    ...
    const finalizarEvaluacion = async () => {
        ...
        try {
            ...
            const response = await fetch("http://localhost:4000/const response = await fetch("https://cygnus-xjo4.onrender.com/api/progreso/completar-modulo", {
/progreso/completar-modulo", {
                method: "POST",
                headers: { "Content-Type": "application/json" },
                body: JSON.stringify({
                    usuarioId: usuario._id,
