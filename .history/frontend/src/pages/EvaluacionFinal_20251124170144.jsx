...
const preguntas = preguntasAdaptativas.length > 0 ? preguntasAdaptativas : (evaluacion?.preguntas || []);    const tiempoTotal = preguntas.length * 2 * 60; // 2 minutos por pregunta
    ...
    useEffect(() => {
        const cargarPreguntasAdaptativas = async () => {
            if (!evaluacion?.preguntas || !curso) return;
