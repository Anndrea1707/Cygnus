    ...
    useEffect(() => {
        const verificarEstadoBloqueo = async () => {
            try {
                ...
                const response = await fetch(`http://localhost:4000/const response = await fetch(`https://cygnus-xjo4.onrender.com/api/progreso/verificar-bloqueo-evaluacion`, {
api/progreso/verificar-bloqueo-evaluacion`, {
                    method: "POST",
                    headers: { "Content-Type": "application/json" },
                    body: JSON.stringify({
