...
export default function EvaluacionFinal({ curso, evaluacion, onNavigate, onEvaluacionCompletada }) {
    ...
    if (evaluacionCompletada) {
        return (
            {/* Modal de inicio de evaluación final */}
{mostrarModalInicio && (
    <div className="modal-overlay">
        <div className="modal-confirmacion">
            ...
            <div className="modal-body">
                <p>Estás a punto de comenzar la evaluación final del curso <strong>{curso.nombre}</strong>.</p>
            ...
            <div className="modal-actions">
                <button
                    ...
                    onClick={() => setMostrarModalInicio(false)} // al confirmar se cierra modal y comienza timer
                >
                    🚀 Comenzar evaluación
                </button>
