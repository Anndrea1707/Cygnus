  ...
  const faqs = [
    {
      ...
      respuesta:
        'Las matemáticas fueron seleccionadas como nuestro piloto porque:', 'Son una de las áreas con mayores dificultades de aprendizaje

Desarrollan pensamiento lógico fundamental para otras disciplinas
