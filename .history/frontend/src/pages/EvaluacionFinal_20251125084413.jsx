...
export default function EvaluacionFinal({ curso, evaluacion, onNavigate, onEvaluacionCompletada }) {
    ...
    useEffect(() => {
        const verificarEstadoBloqueo = async () => {
            try {
                ...
                const response = await fetch(`http://localhost:4000/api/progreso/verificar-bloqueo-evaluacion`, {
                    method: "POST",
                    headers: { "Content-Type": "application/json" },
                    body: JSON.stringify({
    ...
    const finalizarEvaluacion = async () => {
        ...
        try {
            ...
            if (resultEvaluacion.success) {
                ...
                // ✅ NO MOSTRAR MODAL AUTOMÁTICAMENTE - EL USUARIO VERÁ PRIMERO LOS RESULTADOS
                console.log("📋 Resultados mostrados - Modal NO se muestra automáticamente");
            }
    ...
    // ✅ NUEVA FUNCIÓN: Mostrar recomendación cuando el usuario lo solicite
            ...
            <>
                <div className="evaluacion-completada">
                    ...
                    <div className="resultado-container">
                        ...
                        {/* ✅ BOTÓN PARA VER RECOMENDACIÓN - SOLO SI NO APROBÓ */}
                        {!recomendacionActual?.puedeAvanzar && (
                            <div className="recomendacion-accion">
                                <button
                                    className="btn-recomendacion"
                                    onClick={mostrarRecomendacion}
                                >
                                    📚 Ver recomendación de estudio
                                </button>
                            </div>
                        )}
                ...
                {/* Modal para recomendación de repaso - SOLO SE MUESTRA CUANDO EL USUARIO LO SOLICITA */}
                {mostrarModalRecomendacion && (
                    <div className="modal-overlay">
                        <div className="modal-recomendacion">
