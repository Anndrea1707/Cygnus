...
export default function CursoContenido({ curso, moduloIndex = 0, contenidoIndex = 0, onNavigate, onFinalizarCurso }) {
    ...
    useEffect(() => {
        if (forzarEvaluacionFinal) {
            setTimeout(() => {
                setMostrarModalEvaluacionFinal(true);  // tu variable real del modal
            }, 200);
        }
