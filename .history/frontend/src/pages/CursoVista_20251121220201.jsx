...
export default function CursoVista({ onNavigate, curso }) {
  ...
  useEffect(() => {
    const cargarProgreso = async () => {
      ...
      try {
        const response = await fetch(`http://localhost:4000/api/progreso/curso/${usuario._id}/${curso.id}`);
        ...
        <aside className="curso-sidebar">
          <div className="sidebar-contenido">
            ...
            <div className="curso-info-resumen">
              ...
              {/* ✅ AQUÍ VA LA SECCIÓN DE PROGRESO */}
              {progresoCurso && (
              ...
              >
                {progresoCurso && progresoCurso.progresoPorcentual > 0 ? '🚀 Continuar curso' : '🚀 Empezar curso'}
              </button>
            </div>
